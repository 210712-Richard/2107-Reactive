...
public class User implements Serializable {
	...
	private List<HistoricalCat> inventory;
	...
	public User() {
		...
		this.currency = 0l;
		this.inventory = new ArrayList<HistoricalCat>();
	}
	...
	public List<HistoricalCat> getInventory() {
		if(inventory ==  null) {
			inventory = new ArrayList<HistoricalCat>();
		}
		return inventory;
	}
	public void setInventory(List<HistoricalCat> inventory) {
