...
// In the browser, loading the html file
// (and all the files it links to like css and js files)
// takes some time. JavaScript needs to know *when*
// the loading is done. So there is an event that fires
// called "onload". If we provide a callback function
// to our "onload" event, it will call that function
